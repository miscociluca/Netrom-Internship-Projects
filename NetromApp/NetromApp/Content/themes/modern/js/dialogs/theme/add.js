function AddThemeDialog($data) {
    ...
    var fieldset = "" +
        ...
        '<div id="BackgroundColor" class="col-lg-9 input-group colorpicker-component colorpicker-element">' +
          '<input type="text" name="BackgroundColor" value="#2874A6" class="form-control">' +
          '<span class="input-group-addon"><i style="background-color: #2874A6;"></i></span>' +
        '</div>' +
        "</div>" +
        "</div>" +
        // Image
        ...
        '<div id="HeaderBackgroundColor" class="col-lg-9 input-group colorpicker-component colorpicker-element">' +
          '<input type="text" name="HeaderBackgroundColor" value="#2874A6" class="form-control">' +
          '<span class="input-group-addon"><i style="background-color: #2874A6;"></i></span>' +
        '</div>' +
        "</div>" +
        "</div>" +
        ...
        '<div id="HeaderColor" class="col-lg-9 input-group colorpicker-component colorpicker-element">' +
          '<input type="text" name="HeaderColor" value="#2874A6" class="form-control">' +
          '<span class="input-group-addon"><i style="background-color: #2874A6;"></i></span>' +
        '</div>' +
        "</div>" +
        "</div>" +
        ...
        '<div id="CommandBarColor" class="col-lg-9 input-group colorpicker-component colorpicker-element">' +
          '<input type="text" name="CommandBarColor" value="#ffffff" class="form-control">' +
          '<span class="input-group-addon"><i style="background-color: #ffffff;"></i></span>' +
        '</div>' +
        "</div>" +
        "</div>" +
        ...
        '<div id="CommandBarBackgroundColor" class="col-lg-9 input-group colorpicker-component colorpicker-element">' +
          '<input type="text" name="CommandBarBackgroundColor" value="#1E5579" class="form-control">' +
          '<span class="input-group-addon"><i style="background-color: #1E5579;"></i></span>' +
        '</div>' +
        "</div>" +
        "</div>" +
        // Active
        ...
        "</label>" +
        '<div class="col-sm-9">' +
        '<input type="checkbox" name="IsCurrent" id="IsCurrent" value="false">' +
        "</div>" +
        "</div>" +
        "</div>" +
    "</div>";
