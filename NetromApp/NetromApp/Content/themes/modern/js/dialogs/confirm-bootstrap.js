...
(function($) {
    $.fn.confirmModal = function(opts) {
        ...
        return this.each(function () {
            ...
            var buttonTemplate =
                '<button class="btn btn_save" data-dismiss="ok">#Ok#</button>' +
            ...
            modalTemplate = modalTemplate.replace("#buttonTemplate#", buttonTemplate)
            ...
            confirmLink.on("click",
                function(modalEvent) {
                    modalEvent.preventDefault();
                    confirmModal.modal("show");
                });

            $('button[data-dismiss="ok"]', confirmModal)
                .on("click",
                    function(event) {
